...
class DemoApplicationTests {
  ...
  public void getUserTest(){
    User user = userRepository.getUser("manoj1");
  ...
  public void getProductTest(){
    Product product = productRepository.getProduct(2);
  ...
  public void getEmiTest(){
    Emi emi = emiRepository.getEMI(4);
